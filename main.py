...
if choice1 == 'left':
  ...
  if choice2 == 'wait':
    choice3 = input('Awesome! you have reached the island. Here you have three doors in front of you, which one to open? Red, Blue or Yellow ').lower()
    if choice3 == 'red':
      ...
      print("You chose a door that doesn't exist. Game Over.l")
  else:
